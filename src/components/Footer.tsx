...
const footerLinks = {
  ...
  connect: [
    ...
    { href: "https://www.linkedin.com/company/105267243/", label: "LinkedIn", external: true },
  ],
};
    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Organization Links */}
          <div>
            <h3 className="font-semibold text-sm uppercase tracking-wider mb-4">Organization</h3>
